(echo " ^fg(#ffffff)^i(/home/$USER/.dzen/arch_10x10.xbm)^fg(#ffffff) KEK"; echo -e "\
^fg(#ffffff)^i(/home/$USER/.dzen/fox.xbm)^fg()^fg(#ffffff)firefox^pa(80)\n\
^fg(#ffffff)^i(/home/$USER/.dzen/fs_02.xbm)^fg()^fg(#ffffff)thunar^pa(80)\n\
